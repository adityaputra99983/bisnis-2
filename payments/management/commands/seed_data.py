...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        methods = [
            ('Transfer Bank (BCA)', 'Transfer via BCA', 'university'),
            ('Transfer Bank (Mandiri)', 'Transfer via Mandiri', 'university'),
            ('Transfer Bank (BRI)', 'Transfer via BRI', 'university'),
            ('Transfer Bank (BNI)', 'Transfer via BNI', 'university'),
            ('Transfer Bank (BSI)', 'Transfer via BSI', 'university'),
            ('Transfer Bank (CIMB)', 'Transfer via CIMB Niaga', 'university'),
            ('Transfer Bank (Danamon)', 'Transfer via Danamon', 'university'),
            ('Transfer Bank (Permata)', 'Transfer via Permata', 'university'),
            ('Transfer Bank (OCBC)', 'Transfer via OCBC NISP', 'university'),
            ('Transfer Bank (Maybank)', 'Transfer via Maybank', 'university'),
            ('Transfer Bank (Mega)', 'Transfer via Bank Mega', 'university'),
            ('Transfer Bank (Panin)', 'Transfer via Bank Panin', 'university'),
            ('Transfer Bank (BTN)', 'Transfer via Bank BTN', 'university'),
            ('Transfer Bank (Muamalat)', 'Transfer via Bank Muamalat', 'university'),
            ('GoPay', 'Payment via GoPay', 'mobile-alt'),
            ('OVO', 'Payment via OVO', 'mobile-alt'),
            ('DANA', 'Payment via DANA', 'wallet'),
            ('ShopeePay', 'Payment via ShopeePay', 'shopping-bag'),
            ('LinkAja', 'Payment via LinkAja', 'link'),
            ('iSaku', 'Payment via iSaku', 'piggy-bank'),
            ('QRIS', 'Pembayaran via QRIS (semua e-wallet & mobile banking)', 'qrcode'),
